...
|[Week10](/week10/)|데모앱 만들기4           |데모앱을 만들면서 기본 위젯들을 공부해본다.| Chan, Wepol |
|[Week11](/week11/)|Dart 언어, Flutter 동작 구조 이해하기 |Dart를 활용하여 객체 지향에 대해 학습하고, Flutter의 구조에 대해 이해를 해본다.(+시험)| Chan, chi |
|[Week12](/week12/)|Dart 언어, Flutter 동작 구조 이해하기2 |Dart를 활용하여 객체 지향에 대해 학습하고, Flutter의 구조에 대해 이해를 해본다.(+시험)| - |
|[Week12](/week12/)|소켓, Firebase, 데이터베이스 관련 학습 및 구현하기|실시간 통신 및 로컬 저장 및 활용 방법 대해 알아본다.| - |
